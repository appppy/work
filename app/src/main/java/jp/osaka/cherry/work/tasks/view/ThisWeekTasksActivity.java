...
import jp.osaka.cherry.work.databinding.ThisweekTasksActivityBinding;
import jp.osaka.cherry.work.databinding.ThisweekTasksAdmobActivityBinding;
 ...
 * 週画面
 */
public class ThisWeekTasksActivity extends BaseAdmobActivity implements
     ...
     * @serial 目印
     */
    private final String TAG = "ThisWeekTasksActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(BuildConfig.DEBUG) {
            ThisweekTasksActivityBinding binding = DataBindingUtil.setContentView(this, R.layout.thisweek_tasks_activity);
            mToolbar = binding.toolbar;
            mCoordinatorLayout = binding.coordinatorLayout;
            mLayout = binding.contentFrame;
        } else {
            ThisweekTasksAdmobActivityBinding binding = DataBindingUtil.setContentView(this, R.layout.thisweek_tasks_admob_activity);
            mToolbar = binding.toolbar;
            mCoordinatorLayout = binding.coordinatorLayout;
            mLayout = binding.contentFrame;
        ...
        //mBinding = DataBindingUtil.setContentView(this, R.layout.thisweek_tasks_activity);
    ...
    private void setupToolbar() {
        ...
        if (ab != null) {
            ab.setTitle(R.string.this_week);
    ...
    private void setupNavigationDrawer() {
        ...
        mDrawerLayout.addDrawerListener(new DrawerLayout.SimpleDrawerListener() {
            ...
            public void onDrawerClosed(View drawerView) {
                ...
                if (id != R.id.this_week && ThisWeekTasksActivity.class != getStartActivity(id)) {
