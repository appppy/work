...
import static jp.osaka.cherry.work.util.helper.ActivityHelper.startTaskDetailsInFileActivity;

/**
 * ファイル内のタスク詳細画面
 */
public class TasksDetailsInFileActivity extends AppCompatActivity implements
    ...
    public static Intent createIntent(Context context, ArrayList<Asset> assets, String name) {
        Intent intent = new Intent(context, TasksDetailsInFileActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String TAG = "TasksDetailsInFileAct";
        if (LOG_I) {
     ...
     * @param assets 一覧
     */
    private void updateCollectionView(ArrayList<Asset> assets) {
        // 一覧表示の取得
        Fragment fragment = TaskGroupsFragment.newInstance(assets);
    ...
    public void onTaskClicked(View view, Asset asset) {
        startTaskDetailsInFileActivity(this, this, asset);
    }
}
