...
import jp.osaka.cherry.work.databinding.TasksActivityBinding;
import jp.osaka.cherry.work.tasks.TaskItemNavigator;
...
public class TasksActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewModel.setLayout(binding.coordinatorLayout);
        ...
        mViewModel.getOpenTaskEvent().observe(this, asset -> {
            if (asset != null) {
                openTaskDetails(asset.uuid);
            }
        });

        // Subscribe to "new task" event
        mViewModel.getNewTaskEvent().observe(this, __ -> addNewTask());
    ...
    protected void onStart() {
        ...
        if (id != R.id.task && TasksActivity.class != getStartActivity(id)) {
    ...
    public void onSelectMode(int number) {
        ...
        //　ツールバーの設定
        Toolbar toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle(String.valueOf(mViewModel.getSelectedItemsSize()));
        toolbar.setBackgroundColor(ContextCompat.getColor(this, R.color.pink_600));
        ...
        frameLayout.setBackgroundColor(ContextCompat.getColor(this, R.color.pink_800));
        // アクションバーの設定
        ActionBar ab = getSupportActionBar();
        if (ab != null) {
        ...
        if (tasksFragment != null) {
            if (number == 1) {
                tasksFragment.setupFab(TasksFragment.MODE_FAB.MODE_FAB_EDIT_TASK);
            } else {
                tasksFragment.setupFab(TasksFragment.MODE_FAB.MODE_FAB_NONE);
            }
        }
    }
    ...
    public void onNormalMode() {
        ...
        TasksFragment tasksFragment =
                (TasksFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);
        if (tasksFragment != null) {
            tasksFragment.setupFab(TasksFragment.MODE_FAB.MODE_FAB_NEW_TASK);
        }
    }
    ...
    public void openTaskDetails(String taskId) {
        ActivityHelper.startTaskDetailsActivity(this, this, mModel.getTask(taskId));
    }
    ...
    public void addNewTask() {
        ActivityHelper.startNewTaskActivity(this, this, Asset.createInstance());
    }
