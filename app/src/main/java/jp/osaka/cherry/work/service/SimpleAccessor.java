 ...
 * アクセサ
 */
public class SimpleAccessor implements IWorker {
            ...
            public void handleMessage(@NonNull Message msg) {
                ...
                switch(Objects.requireNonNull(type)) {
                    case RESTORE: {
                        ...
                        mDatabase.restore();
                        Assets status = new Assets(mDatabase.getTasks());
                        // 処理結果を通知
                        if (mCallbacks != null) {
                    ...
                    case BACKUP: {
                        ...
                        ArrayList<Asset> assets = command.args.getParcelableArrayList(EXTRA_ASSETS);
                        mDatabase.backup(assets);
                        if (mCallbacks != null) {
                            mCallbacks.onSuccessed(mSelf, (BaseCommand) msg.obj);
                        }
                        break;
