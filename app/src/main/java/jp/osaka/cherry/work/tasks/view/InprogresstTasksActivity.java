...
import jp.osaka.cherry.work.databinding.InprogressTasksActivityBinding;
import jp.osaka.cherry.work.databinding.InprogressTasksAdmobActivityBinding;
...
import static jp.osaka.cherry.work.constants.ActivityTransition.REQUEST_CREATE_TASK;
...
import static jp.osaka.cherry.work.constants.ActivityTransition.REQUEST_OPEN_FILE;
import static jp.osaka.cherry.work.constants.ActivityTransition.REQUEST_OPEN_HISTORY;
 ...
 * 進捗画面
 */
public class InprogresstTasksActivity extends BaseAdmobActivity implements
     ...
     * @serial 目印
     */
    private final String TAG = "InprogresstTasksAct";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(BuildConfig.DEBUG) {
            InprogressTasksActivityBinding binding = DataBindingUtil.setContentView(this, R.layout.inprogress_tasks_activity);
            mToolbar = binding.toolbar;
            mCoordinatorLayout = binding.coordinatorLayout;
            mLayout = binding.contentFrame;
        } else {
            InprogressTasksAdmobActivityBinding binding = DataBindingUtil.setContentView(this, R.layout.inprogress_tasks_admob_activity);
            mToolbar = binding.toolbar;
            mCoordinatorLayout = binding.coordinatorLayout;
            mLayout = binding.contentFrame;
        ...
        //mBinding = DataBindingUtil.setContentView(this, R.layout.inprogress_tasks_activity);
    ...
    private void setupToolbar() {
        ...
        if (ab != null) {
            ab.setTitle(R.string.progress_inprogress);
    ...
    private void setupNavigationDrawer() {
        ...
        mDrawerLayout.addDrawerListener(new DrawerLayout.SimpleDrawerListener() {
            ...
            public void onDrawerClosed(View drawerView) {
                ...
                if (id != R.id.inprogress && InprogresstTasksActivity.class != getStartActivity(id)) {
    ...
    public void onSelectMode(int number) {
        ...
        mToolbar.setBackgroundColor(ContextCompat.getColor(this, R.color.indigo_600));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
            getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.indigo_800));
        }
        // 背景色の変更
        mLayout.setBackgroundColor(ContextCompat.getColor(this, R.color.indigo_800));
        // アクションバーの設定
        ActionBar ab = getSupportActionBar();
        if (ab != null) {
