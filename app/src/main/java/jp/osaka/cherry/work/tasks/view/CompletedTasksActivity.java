...
import jp.osaka.cherry.work.databinding.CompletedTasksActivityBinding;
import jp.osaka.cherry.work.databinding.CompletedTasksAdmobActivityBinding;
 ...
 * 完了タスク画面
 */
public class CompletedTasksActivity extends BaseAdmobActivity implements
     ...
     * @serial 目印
     */
    private final String TAG = "CompletedTasksActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(BuildConfig.DEBUG) {
            CompletedTasksActivityBinding binding = DataBindingUtil.setContentView(this, R.layout.completed_tasks_activity);
            mToolbar = binding.toolbar;
            mCoordinatorLayout = binding.coordinatorLayout;
            mLayout = binding.contentFrame;
        } else {
            CompletedTasksAdmobActivityBinding binding = DataBindingUtil.setContentView(this, R.layout.completed_tasks_admob_activity);
            mToolbar = binding.toolbar;
            mCoordinatorLayout = binding.coordinatorLayout;
            mLayout = binding.contentFrame;
        ...
        //mBinding = DataBindingUtil.setContentView(this, R.layout.completed_tasks_activity);
    ...
    private void setupToolbar(){
        ...
        if (ab != null) {
            ab.setTitle(R.string.progress_completed);
        }
    }
    ...
    private void setupNavigationDrawer() {
        ...
        mDrawerLayout.addDrawerListener(new DrawerLayout.SimpleDrawerListener() {
            ...
            public void onDrawerClosed(View drawerView) {
                ...
                if (id != R.id.completed && CompletedTasksActivity.class != getStartActivity(id)) {
    ...
    public void onSelectMode(int number) {
        ...
        mToolbar.setBackgroundColor(ContextCompat.getColor(this, R.color.brown_600));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
            getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.brown_800));
        }
        // 背景色の変更
        mLayout.setBackgroundColor(ContextCompat.getColor(this, R.color.brown_800));
        // アクションバーの設定
        ActionBar ab = getSupportActionBar();
        if (ab != null) {
    ...
    public void onNormalMode() {
        ...
        mToolbar.setBackgroundColor(ContextCompat.getColor(this, R.color.green_600));
        // ステータスバーの変更
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
            getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.green_800));
        }
        // 背景色の変更
        mLayout.setBackgroundColor(ContextCompat.getColor(this, R.color.green_800));
        // アクションバーの設定
        ActionBar ab = getSupportActionBar();
        if (ab != null) {
