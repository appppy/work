...
import jp.osaka.cherry.work.databinding.NotStartTasksActivityBinding;
import jp.osaka.cherry.work.databinding.NotStartTasksAdmobActivityBinding;
 ...
 * 未開始画面
 */
public class NotStartTasksActivity extends BaseAdmobActivity implements
     ...
     * @serial 目印
     */
    private final String TAG = "NotStartTasksActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(BuildConfig.DEBUG) {
            NotStartTasksActivityBinding binding = DataBindingUtil.setContentView(this, R.layout.not_start_tasks_activity);
            mToolbar = binding.toolbar;
            mCoordinatorLayout = binding.coordinatorLayout;
            mLayout = binding.contentFrame;
        } else {
            NotStartTasksAdmobActivityBinding binding = DataBindingUtil.setContentView(this, R.layout.not_start_tasks_admob_activity);
            mToolbar = binding.toolbar;
            mCoordinatorLayout = binding.coordinatorLayout;
            mLayout = binding.contentFrame;
        ...
        //mBinding = DataBindingUtil.setContentView(this, R.layout.not_start_tasks_activity);
    ...
    private void setupToolbar() {
        ...
        if (ab != null) {
            ab.setTitle(R.string.progress_not_start);
    ...
    private void setupNavigationDrawer() {
        ...
        mDrawerLayout.addDrawerListener(new DrawerLayout.SimpleDrawerListener() {
            ...
            public void onDrawerClosed(View drawerView) {
                ...
                if (id != R.id.not_start && NotStartTasksActivity.class != getStartActivity(id)) {
    ...
    public void onSelectMode(int number) {
        ...
        mToolbar.setBackgroundColor(ContextCompat.getColor(this, R.color.teal_600));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
            getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.teal_800));
        }
        // 背景色の変更
        mLayout.setBackgroundColor(ContextCompat.getColor(this, R.color.teal_800));
        // アクションバーの設定
        ActionBar ab = getSupportActionBar();
        if (ab != null) {
