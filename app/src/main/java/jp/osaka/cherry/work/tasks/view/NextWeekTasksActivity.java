...
import jp.osaka.cherry.work.databinding.NextweekTasksActivityBinding;
 ...
 * 次週画面
 */
public class NextWeekTasksActivity extends BaseAdmobActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(BuildConfig.DEBUG) {
            NextweekTasksActivityBinding binding = DataBindingUtil.setContentView(this, R.layout.nextweek_tasks_activity);
            mToolbar = binding.toolbar;
            mCoordinatorLayout = binding.coordinatorLayout;
            mLayout = binding.contentFrame;
        } else {
            NextweekTasksActivityBinding binding = DataBindingUtil.setContentView(this, R.layout.nextweek_tasks_admob_activity);
            mToolbar = binding.toolbar;
            mCoordinatorLayout = binding.coordinatorLayout;
            mLayout = binding.contentFrame;
        ...
        //mBinding = DataBindingUtil.setContentView(this, R.layout.nextweek_tasks_activity);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        String TAG = "NextWeekTasksActivity";
        if (LOG_I) {
    ...
    private void setupToolbar() {
        ...
        if (ab != null) {
            ab.setTitle(R.string.next_week);
    ...
    private void setupNavigationDrawer() {
        ...
        mDrawerLayout.addDrawerListener(new DrawerLayout.SimpleDrawerListener() {
            ...
            public void onDrawerClosed(View drawerView) {
                ...
                if (id != R.id.next_week && NextWeekTasksActivity.class != getStartActivity(id)) {
    ...
    public void onSelectMode(int number) {
        ...
        mToolbar.setBackgroundColor(ContextCompat.getColor(this, R.color.grey_600));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
            getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.grey_800));
        }
        // 背景色の変更
        mLayout.setBackgroundColor(ContextCompat.getColor(this, R.color.grey_800));
        // アクションバーの設定
        ActionBar ab = getSupportActionBar();
        if (ab != null) {
