 ...
 * ファイル内のタスク詳細画面
 */
public class TaskDetailsInFileActivity extends AppCompatActivity {
    ...
    public static Intent createIntent(Context context, Asset asset) {
        Intent intent = new Intent(context, TaskDetailsInFileActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String TAG = "TaskDetailsInFileAct";
        if (LOG_I) {
